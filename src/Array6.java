//Target sum of three  problem using array
//The method to solve this problem is using nested loop within nested loop
...
public class Array6 {
    static int pairSum(int[] arr, int target) {
        ...
        for (int i = 0; i < n; i++) {//This will take the first number
            ...
            {
                for (int k = j + 1; k < n; k++) {//Used to find the third number
